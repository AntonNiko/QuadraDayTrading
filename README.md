...
Throughout the entirety of the testing process, none of the workloads caused the system to fail and to restart, which means that the slowdown in performance was largely due to the increased latency and decreased responsiveness of the system from having to process so many transactions simultaneously.
